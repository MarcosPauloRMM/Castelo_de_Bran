...
$historia = [
    ...
    'sinopse-historia' => $_POST['sinopse-historia'] ?? null,
    'autor-historia' => $_POST['autor-historia'] ?? null
];

try{
    $insert = "INSERT INTO historia (cd_historia, cd_leitor, nm_historia, ds_genero, ds_sinopse, ds_conteudo) VALUES (:codigoHistoria, :codigoLeitor, :nomeHistoria, :generoHistoria, :sinopseHistoria, :conteudoHistoria)";        
    ...
    $comando->bindParam(':sinopseHistoria', $historia['sinopse-historia']);
